...
app.post('/login', async (req, res) => {
    ...
    const isAdmin = email == 'admin@example.com' && password == 'admin@070';
...
app.get('/getAllCatogory', async (req, res) => {
    const category = await getAllCatogory();
    res.json(category);
});
